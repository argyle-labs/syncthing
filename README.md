...
Syncthing file synchronization — a first-party [orca](https://github.com/argyle-labs/orca) **service-backend**
...
`deploy`, `backup`, `restore`, `configure`, `status`. Rich, syncthing-specific data is
